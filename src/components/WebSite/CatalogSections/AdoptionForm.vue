<template>
    <div class="page page-color bg-blue-50 min-h-screen flex justify-center items-start py-6 md:py-10">
        <Section class="sectionAdoptionForm w-full">
            <Toast />
            <div
                class="container mx-auto max-w-3xl w-full bg-white/95 rounded-3xl shadow-lg px-4 py-6 md:px-8 md:py-8"
            >
                <!-- TÍTULO -->
                ...
                >
                    ...
                    <div class="form space-y-4">
                        ...
                        <div class="sameField grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="district field flex flex-col gap-1">
                                ...
                                <Select
                                    ...
                                    fluid
                                    :options="oListDistricts"
                                    optionLabel="districtDesc"
                        ...
                        <div class="phoneNumber field flex flex-col gap-1">
                            ...
                            <InputNumber
                                v-model="oApplicant.phoneNumber"
                                :useGrouping="false"
                                :min="900000000"
                                :max="999999999"
                                class="w-full"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="permissions flex flex-col gap-3">
                            ...
                            >
                                <a
                                    class="title flex items-center gap-2 text-sm font-semibold text-slate-800 hover:text-cyan-700"
                                    href="/src/assets/pdf/29733.pdf"
                                    target="_blank"
                                    rel="noopener"
                                    as="a"
                                >
                ...
                <!-- ACCIONES -->
                <div
                    class="actions mt-6 flex flex-col md:flex-row gap-3 md:justify-end"
                >
                    <Button
                        label="Enviar"
                        ...
                        iconPos="right"
                        fluid
                        class="primary hover:bg-amber-600 transition font-semibold md:w-40"
                        @click="sendApplication()"
                        :disabled="!oApplicant.useData || !oApplicant.tyc"
                    />
                    <Button
                        label="Cancelar"
                        icon="ri-close-fill text-lg"
                        iconPos="right"
                        fluid
                        class="secondary md:w-40"
                        @click="goBack(idDog)"
                    />
                </div>
            </div>
